...
(1, 'Normal'), (2, 'Water'), (3, 'Fire'), 
(4, 'Grass'), (5, 'Electric'), (6, 'Ground'),
(7, 'Ice'), (8, 'Fighting'), (9, 'Flying'),
(10, 'Rock'), (11, 'Bug'), (12, 'Psychic'),
(13, 'Poison'), (14, 'Ghost'), (15, 'Dragon'),
(16, 'Steel'), (17, 'Dark'), (18, 'Fairy');

INSERT INTO abilities (name, game_text) VALUES
...
('Mega Sol','Moves act as if there is harsh sunlight.'),
...
INSERT INTO natures (name, increases, decreases) VALUES 
...
('Crystal'), ('Ruby'), ('Sapphire'), ('Fire Red'), ('Leaf Green'),
('Emerald'), ('Diamond'), ('Pearl'), ('Platinum'), ('Heart Gold'),
('Soul Silver'), ('Black'), ('White'), ('Black2'), ('White2'),
('X'), ('Y'), ('Omega Ruby'), ('Alpha Sapphire'), ('Sun'),
('Moon'), ('Ultra Sun'), ('Ultra Moon'), ('Sword'), ('Shield'),
('Brilliant Diamond'), ('Shining Pearl'), ('Scarlet'), ('Violet'), ('Legends: Arceus'),
('Legends: ZA'), ('Pokemon GO'), ('Let''s Go, Pikachu!'), ('Let''s Go, Eevee!');